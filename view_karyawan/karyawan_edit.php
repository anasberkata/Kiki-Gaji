...
if (isset($_POST["karyawan_edit"])) {
    if (karyawan_edit($_POST) > 0) {
        echo "<script>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="number" id="gaji_pokok" name="gaji_pokok" value="<?= $karyawan['gaji_pokok'] ?>" />
                            </div>
                        </div>

                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                <button type="submit" name="karyawan_edit" class="btn btn-primary">Ubah</button>
                            </div>
                        </div>
                    </form>
